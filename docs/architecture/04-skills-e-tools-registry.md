...
| `memoryAgent` | `memory` | Qualquer | Memória cognitiva RAG, gravação de combinados, preferências e perfil. | `readMemory`, `consolidateMemory`, `deleteSemanticMemory`, `searchSemanticMemory`, `storeSemanticMemory`, `searchEventSummary` |
